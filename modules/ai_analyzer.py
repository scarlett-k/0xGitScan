...
def analyze_github_repos(repos):
    ...
    prompt = (
        ...
        f"Find any security vulnerabilities in the repositories and tell me how a hacker can exploit them. Also, give recommendations on how to get rid of these risks or mitigate them."
    )
